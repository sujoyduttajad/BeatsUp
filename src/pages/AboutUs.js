    ...
    <div>
      ...
      <section className="about-container">
        ...
        <div className="about">
          <h1>About Us</h1>
          <p>
            Hi, I am Sujoy the creator of BeatsUp, a music app that plays chill
            music from any devices you want to play, it's a responsive web app
            for now but I'm planning to migrate it to a PWA app so that it could
            be downloadable in smratphones.
          </p>

          <p>
            This app plays cool music that anybody at anytime can enjoy and have
            a good time(chill out). I made this app to play my favourite songs
            continuously(repeat) without showing any adds or whatever.
          </p>
        </div>
      </section>
      {/* ###########      Bio-data container    ############### */}
      <section className="bioData-container">
        <div className="bioData-intro">
          ...
          <p className="content">
            I have 3+ years of experience in UI with a tech-stack of React.js,
            Next.js, Redux, Node, SASS, JavaScript, HTML5, CSS3, Bootstrap
          </p>
          <p className="content">
            I am still learning UX design but much inclined towards visual UI
            design. This app is all designed by me(super proud).
          </p>
          <p className="content">
            I am a photographer also enjoy playing guitar in my free time.
          </p>
      ...
      <section className="contactus-container">
        <div className="contactus-intro">
          <h1>Get in Touch</h1>
          <p>
            Have any inquiry or feedback for us? Contact us directly or fill out
        ...
        <div className="banner-strip">
          <div className="banner__logo__container">
            <Lottie options={logoOptions} height={60} width={60} />
          ...
          <div className="contactus-terms-conditions">
            ...
            <p>
              <a href="#">© 2021 BeatsUp, Inc.</a>
            </p>
          </div>
        </div>
        {/* ############     Mail Animation     ############ */}
        <div className="mail-animation">
          <Lottie options={contactUsOptions} height={720} width={820} />
        </div>
      </section>
    </div>
  );
