      ...
      <div className="sidebar__container">
        <section className="section">
          ...
          <NavLink to="/AboutUs" activeStyle={{ outline: "none" }}>
            <div>
              ...
              <span className="concentrator-plus-clip">
          ...
          <div>
            ...
            <span className="concentrator-plus">
        ...
        <section className="section">
          ...
          <div>
            ...
            <span className="concentrator">
              <FontAwesomeIcon size="2x" icon={faMicrophoneAlt} />
            </span>
          </div>
        </section>
        ...
        <section className="section">
          ...
          <div>
            ...
            <span className="concentrator-plus">
              <FontAwesomeIcon size="2x" icon={faBroadcastTower} />
            </span>
          </div>
          <div>
            <div className="nav__container">
            ...
            <span className="concentrator-plus nero">
